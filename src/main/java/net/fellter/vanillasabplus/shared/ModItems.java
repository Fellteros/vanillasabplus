...
public class ModItems {
    ...
    public static final Item STONE_SIGN = registerBlock("stone_sign", settings ->  new SignItem(ModBlocks.STONE_SIGN, ModBlocks.WALL_STONE_SIGN, settings.maxCount(16)));
    public static final Item HANGING_STONE_SIGN = registerBlock("stone_hanging_sign", settings ->  new HangingSignItem(ModBlocks.HANGING_STONE_SIGN, ModBlocks.HANGING_WALL_STONE_SIGN, settings.maxCount(16)));
    ...
    public static final Item COBBLESTONE_SIGN = registerBlock("cobblestone_sign", settings ->  new SignItem(ModBlocks.COBBLESTONE_SIGN, ModBlocks.WALL_COBBLESTONE_SIGN, settings.maxCount(16)));
    public static final Item COBBLESTONE_HANGING_SIGN = registerBlock("cobblestone_hanging_sign", settings ->  new HangingSignItem(ModBlocks.HANGING_COBBLESTONE_SIGN, ModBlocks.HANGING_WALL_COBBLESTONE_SIGN, settings.maxCount(16)));
    ...
    public static final Item MOSSY_COBBLESTONE_SIGN = registerBlock("mossy_cobblestone_sign", settings ->  new SignItem(ModBlocks.MOSSY_COBBLESTONE_SIGN, ModBlocks.WALL_MOSSY_COBBLESTONE_SIGN, settings.maxCount(16)));
    public static final Item MOSSY_COBBLESTONE_HANGING_SIGN = registerBlock("mossy_cobblestone_hanging_sign", settings ->  new HangingSignItem(ModBlocks.HANGING_MOSSY_COBBLESTONE_SIGN, ModBlocks.HANGING_WALL_MOSSY_COBBLESTONE_SIGN, settings.maxCount(16)));
    ...
    public static final Item SMOOTH_STONE_SIGN = registerBlock("smooth_stone_sign", settings ->  new SignItem(ModBlocks.SMOOTH_STONE_SIGN, ModBlocks.WALL_SMOOTH_STONE_SIGN, settings.maxCount(16)));
    public static final Item SMOOTH_STONE_HANGING_SIGN = registerBlock("smooth_stone_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_SMOOTH_STONE_SIGN, ModBlocks.HANGING_WALL_SMOOTH_STONE_SIGN, settings.maxCount(16)));
    ...
    public static final Item STONE_BRICKS_SIGN = registerBlock("stone_bricks_sign", settings ->  new SignItem(ModBlocks.STONE_BRICKS_SIGN, ModBlocks.WALL_STONE_BRICKS_SIGN, settings.maxCount(16)));
    public static final Item STONE_BRICKS_HANGING_SIGN = registerBlock("stone_bricks_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_STONE_BRICKS_SIGN, ModBlocks.HANGING_WALL_STONE_BRICKS_SIGN, settings.maxCount(16)));
    ...
    public static final Item CRACKED_STONE_BRICKS_SIGN = registerBlock("cracked_stone_bricks_sign", settings -> new SignItem(ModBlocks.CRACKED_STONE_BRICKS_SIGN, ModBlocks.WALL_CRACKED_STONE_BRICKS_SIGN, settings.maxCount(16)));
    public static final Item CRACKED_STONE_BRICKS_HANGING_SIGN = registerBlock("cracked_stone_bricks_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_CRACKED_STONE_BRICKS_SIGN, ModBlocks.HANGING_WALL_CRACKED_STONE_BRICKS_SIGN, settings.maxCount(16)));
    ...
    public static final Item MOSSY_STONE_BRICKS_SIGN = registerBlock("mossy_stone_bricks_sign", settings -> new SignItem(ModBlocks.MOSSY_STONE_BRICKS_SIGN, ModBlocks.WALL_MOSSY_STONE_BRICKS_SIGN, settings.maxCount(16)));
    public static final Item MOSSY_STONE_BRICKS_HANGING_SIGN = registerBlock("mossy_stone_bricks_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_MOSSY_STONE_BRICKS_SIGN, ModBlocks.HANGING_WALL_MOSSY_STONE_BRICKS_SIGN, settings.maxCount(16)));
    ...
    public static final Item GRANITE_SIGN = registerBlock("granite_sign", settings -> new SignItem(ModBlocks.GRANITE_SIGN, ModBlocks.WALL_GRANITE_SIGN, settings.maxCount(16)));
    public static final Item GRANITE_HANGING_SIGN = registerBlock("granite_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_GRANITE_SIGN, ModBlocks.HANGING_WALL_GRANITE_SIGN, settings.maxCount(16)));
    ...
    public static final Item POLISHED_GRANITE_SIGN = registerBlock("polished_granite_sign", settings -> new SignItem(ModBlocks.POLISHED_GRANITE_SIGN, ModBlocks.WALL_POLISHED_GRANITE_SIGN, settings.maxCount(16)));
    public static final Item POLISHED_GRANITE_HANGING_SIGN = registerBlock("polished_granite_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_POLISHED_GRANITE_SIGN, ModBlocks.HANGING_WALL_POLISHED_GRANITE_SIGN, settings.maxCount(16)));
    ...
    public static final Item DIORITE_SIGN = registerBlock("diorite_sign", settings -> new SignItem(ModBlocks.DIORITE_SIGN, ModBlocks.WALL_DIORITE_SIGN, settings.maxCount(16)));
    public static final Item DIORITE_HANGING_SIGN = registerBlock("diorite_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_DIORITE_SIGN, ModBlocks.HANGING_WALL_DIORITE_SIGN, settings.maxCount(16)));
    ...
    public static final Item POLISHED_DIORITE_SIGN = registerBlock("polished_diorite_sign", settings -> new SignItem(ModBlocks.POLISHED_DIORITE_SIGN, ModBlocks.WALL_POLISHED_DIORITE_SIGN, settings.maxCount(16)));
    public static final Item POLISHED_DIORITE_HANGING_SIGN = registerBlock("polished_diorite_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_POLISHED_DIORITE_SIGN, ModBlocks.HANGING_WALL_POLISHED_DIORITE_SIGN,
    ...
    public static final Item ANDESITE_SIGN = registerBlock("andesite_sign", settings -> new SignItem(ModBlocks.ANDESITE_SIGN, ModBlocks.WALL_ANDESITE_SIGN, settings.maxCount(16)));
    public static final Item ANDESITE_HANGING_SIGN = registerBlock("andesite_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_ANDESITE_SIGN, ModBlocks.HANGING_WALL_ANDESITE_SIGN, settings.maxCount(16)));
    ...
    public static final Item POLISHED_ANDESITE_SIGN = registerBlock("polished_andesite_sign", settings -> new SignItem(ModBlocks.POLISHED_ANDESITE_SIGN, ModBlocks.WALL_POLISHED_ANDESITE_SIGN, settings.maxCount(16)));
    public static final Item POLISHED_ANDESITE_HANGING_SIGN = registerBlock("polished_andesite_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_POLISHED_ANDESITE_SIGN, ModBlocks.HANGING_WALL_POLISHED_ANDESITE_SIGN, settings.maxCount(16)));
    ...
    public static final Item DEEPSLATE_CHEST_BOAT = registerItem("deepslate_chest_boat", settings -> new BoatItem(ModEntityTypes.DEEPSLATE_CHEST_BOAT, settings.maxCount(1)));
    public static final Item DEEPSLATE_SIGN = registerBlock("deepslate_sign", settings -> new SignItem(ModBlocks.DEEPSLATE_SIGN, ModBlocks.WALL_DEEPSLATE_SIGN, settings.maxCount(16)));
    public static final Item DEEPSLATE_HANGING_SIGN = registerBlock("deepslate_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_DEEPSLATE_SIGN,
    ...
    public static final Item COBBLED_DEEPSLATE_SIGN = registerBlock("cobbled_deepslate_sign", settings -> new SignItem(ModBlocks.COBBLED_DEEPSLATE_SIGN, ModBlocks.WALL_COBBLED_DEEPSLATE_SIGN, settings.maxCount(16)));
    public static final Item COBBLED_DEEPSLATE_HANGING_SIGN = registerBlock("cobbled_deepslate_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_COBBLED_DEEPSLATE_SIGN,
    ...
    public static final Item CHISELED_DEEPSLATE_SIGN = registerBlock("chiseled_deepslate_sign", settings -> new SignItem(ModBlocks.CHISELED_DEEPSLATE_SIGN, ModBlocks.WALL_CHISELED_DEEPSLATE_SIGN, settings.maxCount(16)));
    public static final Item CHISELED_DEEPSLATE_HANGING_SIGN = registerBlock("chiseled_deepslate_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_CHISELED_DEEPSLATE_SIGN,
    ...
    public static final Item POLISHED_DEEPSLATE_SIGN = registerBlock("polished_deepslate_sign", settings -> new SignItem(ModBlocks.POLISHED_DEEPSLATE_SIGN, ModBlocks.WALL_POLISHED_DEEPSLATE_SIGN, settings.maxCount(16)));
    public static final Item POLISHED_DEEPSLATE_HANGING_SIGN = registerBlock("polished_deepslate_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_POLISHED_DEEPSLATE_SIGN,
    ...
    public static final Item DEEPSLATE_BRICKS_SIGN = registerBlock("deepslate_bricks_sign", settings -> new SignItem(ModBlocks.DEEPSLATE_BRICKS_SIGN, ModBlocks.WALL_DEEPSLATE_BRICKS_SIGN, settings.maxCount(16)));
    public static final Item DEEPSLATE_BRICKS_HANGING_SIGN = registerBlock("deepslate_bricks_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_DEEPSLATE_BRICKS_SIGN,
    ...
    public static final Item CRACKED_DEEPSLATE_BRICKS_SIGN = registerBlock("cracked_deepslate_bricks_sign", settings -> new SignItem(ModBlocks.CRACKED_DEEPSLATE_BRICKS_SIGN, ModBlocks.WALL_CRACKED_DEEPSLATE_BRICKS_SIGN, settings.maxCount(16)));
    public static final Item CRACKED_DEEPSLATE_BRICKS_HANGING_SIGN = registerBlock("cracked_deepslate_bricks_hanging_sign", settings -> new HangingSignItem(ModBlocks.HANGING_CRACKED_DEEPSLATE_BRICKS_SIGN,
    ...
    private static Item registerBlock(String name, Function<Item.Settings, Item> function) {
